...
%% 主文档字体设置
\setmainfont[ Path = fonts/Main/, Extension = .otf, BoldFont = texgyretermes-bold.otf, % 加粗字体
]{texgyretermes-regular.otf} % 正文字体
% 中文字体设置
\setCJKmainfont[ Path = fonts/hansans/, Extension = .ttf, BoldFont = NotoSansSC-Bold.ttf, % 加粗字体
...
%%%% 利用tikz来定位照片（如不需要照片，可将下面三行代码注释掉）
\begin{tikzpicture}[remember picture, overlay]  
  \node[anchor = north east] at ($(current page.north east)+(-2cm,-1.2cm)$) {\includegraphics[height=3cm]{avatar.jpg}}; 
\end{tikzpicture}

% ====== 个人信息部分 ======
\centerline{\LARGE\bfseries{何张扬}} 
\vspace{0.5em}
\centerline{\normalsize{\faPhone\ 130-6333-7907 \quad \faEnvelopeO\ \href{mailto:kaiserrepublik@outlook.com}{kaiserrepublik@outlook.com}}} 
\centerline{\normalsize{籍贯：安徽省合肥市 \quad 政治面貌：共青团员 \quad 出生年月：2002.08}}  

% ====== 教育背景 ======
\section{\makebox[\widthof{\faGraduationCap}][c]{\color{CVBlue}\faGraduationCap}\ 教育背景} 
\textbf{浙江大学} \hfill 2023.9 -- 至今\\[0.5em] 
